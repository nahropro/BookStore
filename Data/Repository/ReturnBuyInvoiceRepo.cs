...
{
    public class ReturnBuyInvoiceRepo:Repository<ReturnBuyInvoice>
    {
        public ReturnBuyInvoiceRepo(BookStoreDbContext bookStoreDbContext):base(bookStoreDbContext)
        {

        }

        public ReturnBuyInvoice Add(CreateEditItemInvoiceViewModel model, string userId)
        {
        ...
        public override ReturnBuyInvoice Add(ReturnBuyInvoice entity)
        {
        ...
        public async Task<List<ReturnBuyInvoice>> FilterNoTrackingWithIncludesAsync(ItemInvoiceFilter filter = null,
            bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<ReturnBuyInvoice> invoice;
        ...
        public async Task<ReturnBuyInvoice> GetNoTrackingWithIncludesAsync(
        ...
        public async Task<ReturnBuyInvoice> GetWithIncludesAsync(
            long id, bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<ReturnBuyInvoice> invoice;
