...
{
    public class ReturnBuyItemRepo:Repository<ReturnBuyItem>
    {
        public ReturnBuyItemRepo(BookStoreDbContext bookStoreDbContext):base(bookStoreDbContext)
        {

        }

        public async Task<List<ReturnBuyItem>> FindNoTrackinWithIncludesAsync(Expression<Func<ReturnBuyItem, bool>> expression,
            bool includeInvoice = false, bool includeStore = false, bool includeBookEdition = false, bool includeCustomer=false)
        {
            IQueryable<ReturnBuyItem> sellItems;
