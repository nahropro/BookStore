...
{
    public class TempSellInvoiceRepo:Repository<TempSellInvoice>
    {
        public TempSellInvoiceRepo(BookStoreDbContext bookStoreDbContext):base(bookStoreDbContext)
        {

        }

        public TempSellInvoice Add(CreateEditItemInvoiceViewModel model, string userId)
        {
        ...
        public override TempSellInvoice Add(TempSellInvoice entity)
        {
        ...
        public async Task<List<TempSellInvoice>> FilterNoTrackingWithIncludesAsync(ItemInvoiceFilter filter = null,
            bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<TempSellInvoice> invoice;
        ...
        public async Task<TempSellInvoice> GetNoTrackingWithIncludesAsync(
        ...
        public async Task<TempSellInvoice> GetWithIncludesAsync(
            long id, bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<TempSellInvoice> invoice;
