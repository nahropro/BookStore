...
{
    public class SellInvoiceRepo:Repository<SellInvoice>
    {
        public SellInvoiceRepo(BookStoreDbContext bookStoreDbContext):base(bookStoreDbContext)
        {

        }

        public SellInvoice Add(CreateEditItemInvoiceViewModel model, string userId)
        {
            SellInvoice invoice;
        ...
        public override SellInvoice Add(SellInvoice entity)
        {
        ...
        public async Task<List<SellInvoice>> FilterNoTrackingWithIncludesAsync(ItemInvoiceFilter filter=null,
            bool includeCustomer=false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<SellInvoice> invoice;
        ...
        public async Task<SellInvoice> GetNoTrackingWithIncludesAsync(
        ...
        public async Task<SellInvoice> GetWithIncludesAsync(
            long id, bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<SellInvoice> invoice;
