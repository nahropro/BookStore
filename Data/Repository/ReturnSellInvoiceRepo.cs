...
{
    public class ReturnSellInvoiceRepo:Repository<ReturnSellInvoice>
    {
        public ReturnSellInvoiceRepo(BookStoreDbContext bookStoreDbContext):base(bookStoreDbContext)
        {

        }

        public ReturnSellInvoice Add(CreateEditItemInvoiceViewModel model, string userId)
        {
        ...
        public override ReturnSellInvoice Add(ReturnSellInvoice entity)
        {
        ...
        public async Task<List<ReturnSellInvoice>> FilterNoTrackingWithIncludesAsync(ItemInvoiceFilter filter = null,
            bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<ReturnSellInvoice> invoice;
        ...
        public async Task<ReturnSellInvoice> GetNoTrackingWithIncludesAsync(
        ...
        public async Task<ReturnSellInvoice> GetWithIncludesAsync(
            long id, bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<ReturnSellInvoice> invoice;
