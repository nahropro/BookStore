...
{
    public class ReturnTempSellInvoiceRepo:Repository<ReturnTempSellInvoice>
    {
        public ReturnTempSellInvoiceRepo(BookStoreDbContext bookStoreDbContext):base(bookStoreDbContext)
        {

        }

        public ReturnTempSellInvoice Add(CreateEditItemInvoiceViewModel model, string userId)
        {
        ...
        public override ReturnTempSellInvoice Add(ReturnTempSellInvoice entity)
        {
        ...
        public async Task<List<ReturnTempSellInvoice>> FilterNoTrackingWithIncludesAsync(ItemInvoiceFilter filter = null,
            bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<ReturnTempSellInvoice> invoice;
        ...
        public async Task<ReturnTempSellInvoice> GetNoTrackingWithIncludesAsync(
        ...
        public async Task<ReturnTempSellInvoice> GetWithIncludesAsync(
            long id, bool includeCustomer = false, bool includeItems = false, bool includeBookEdition = false, bool includeStore = false)
        {
            IQueryable<ReturnTempSellInvoice> invoice;
