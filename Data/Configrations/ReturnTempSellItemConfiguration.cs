...
{
    public class ReturnTempSellItemConfiguration : EntityTypeConfiguration<ReturnTempSellItem>
    {
        public ReturnTempSellItemConfiguration()
        {
            //Set relationship between invoice-item and invoice
            this.HasRequired<ReturnTempSellInvoice>(i => i.Invoice)
                .WithMany(i => i.Items)
            ...
            this.HasRequired<BookEdition>(i => i.BookEdition)
                .WithMany(i => i.ReturnTempSellItems)
